...
VALUES ('HELENA',123,11928387322,'HELENA@HELENA',2,1,13),
		('FERNANDO',456,11983325712,'FERNANDO@FERNANDO',2,2,14),
		('FILIPE',789,11984330932,'FILIPE@FILIPE',1,3,15),
		('DENAO',234,1196231836,'DENAO@DENAO',1,1,16),
		('LUCIANO',432,11938235278,'LUCIANO@LUCIANO',1,2,13);
